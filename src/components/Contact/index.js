                ...
                <div id="title" >
                    ...
                    <div class="row">
                        <a href="https://www.linkedin.com/in/stylianos-thomas/" target="_blank" class="btn col">
                            <iconify-icon data-icon="ant-design:linkedin-filled" class="iconStyle"/>
                        </a>
                        <a href="https://github.com/StylianosThomas" target="_blank" class="btn col">
                            <iconify-icon data-icon="ant-design:github-filled" class="iconStyle"/>
                        </a>
                        <a href="#contact" class="btn col">
                            <iconify-icon data-icon="clarity:email-solid" class="iconStyle"/>
                        </a>
                    </div>
                </div>
            </div>
